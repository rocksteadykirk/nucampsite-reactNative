...
const AboutScreen = () => {
    ...
    return (
        <ScrollView>
            ...
            <Card>
                <Card.Title>Community Partner</Card.Title>
                <Card.Divider />
